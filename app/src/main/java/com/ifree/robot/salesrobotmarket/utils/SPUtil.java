...
public class SPUtil {
    ...
    public static String getUid(Context context){
        return SPUtil.getString(context,"uid");
    }

    public static String getLatitude(Context context){
        return SPUtil.getString(context,"latitude");
    }

    public static String getLongitude(Context context){
        return SPUtil.getString(context,"longitude");
    }

    public static String getTownAdCode(Context context){
