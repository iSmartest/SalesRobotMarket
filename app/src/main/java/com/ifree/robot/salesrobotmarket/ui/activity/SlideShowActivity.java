...
public class SlideShowActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        final ConsultEntity.DataBean.AnswersBean answersBean = (ConsultEntity.DataBean.AnswersBean) getIntent().getSerializableExtra("consult");
    ...
    public class ImageAdapter extends PagerAdapter {
        ...
        private List<ConsultEntity.DataBean.AnswersBean.PicsBean> mShopImgList;

        public ImageAdapter(Context mContext, List<ConsultEntity.DataBean.AnswersBean.PicsBean> mShopImgList) {
