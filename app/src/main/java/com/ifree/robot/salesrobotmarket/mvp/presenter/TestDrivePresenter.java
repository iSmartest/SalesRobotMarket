 ...
 * Description:
 */
public class TestDrivePresenter implements Presenter {
    ...
    public TestDrivePresenter(Context mContext){
    ...
    public void getQuestTestDriveInfo(String storeId,String carId,String phoneNumber,String date,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext,mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getQuestTestDriveInfo(storeId, carId,phoneNumber,date)
